...
|-------------------------------|---------------------------------|---------------------------------------|
| `CLAUDE_MEM_MODEL`            | `claude-sonnet-4-5`             | AI model for processing observations (shorthand: `haiku`, `sonnet`, `opus`) |
...
| `CLAUDE_MEM_GEMINI_BASE_URL`  | —                               | Custom models base URL (optional, for proxies/self-hosted) |
...
| `CLAUDE_MEM_OPENROUTER_BASE_URL`             | —                           | Custom endpoint URL (optional, for proxies/self-hosted) |
